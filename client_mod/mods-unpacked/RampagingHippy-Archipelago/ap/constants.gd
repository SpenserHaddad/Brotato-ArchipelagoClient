...
const CHARACTER_NAME_TO_ID = {
	...
	"Captain": "character_captain",
	"Creature": "character_creature",
	"Chef": "character_chef",
	"Druid": "character_druid",
	"Dwarf": "character_dwarf",
	"Gangster": "character_gangster",
	"Diver": "character_diver",
	"Hiker": "character_hiker",
	"Buccaneer": "character_buccaneer",
	"Ogre": "character_ogre",
	"Romantic": "character_romantic",
}
...
const PROGRESSIVE_WAVE_CAP_INCREASE_ITEM_TEMPLATE = "Progressive Wave Cap ({char})"
