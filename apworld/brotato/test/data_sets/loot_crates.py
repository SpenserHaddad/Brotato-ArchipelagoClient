...
LOOT_CRATE_GROUP_DATA_SETS: list[BrotatoLootCrateTestDataSet] = [
    ...
    BrotatoLootCrateTestDataSet(
        ...
        expected_legendary_groups=[
            ...
            BrotatoLootCrateGroup(3, 1, 4),
            BrotatoLootCrateGroup(4, 1, 6),
            BrotatoLootCrateGroup(5, 1, 8),
            BrotatoLootCrateGroup(6, 1, 10),
            BrotatoLootCrateGroup(7, 1, 12),
            BrotatoLootCrateGroup(8, 1, 14),
            BrotatoLootCrateGroup(9, 1, 16),
            BrotatoLootCrateGroup(10, 1, 18),
        ],
    ),
    BrotatoLootCrateTestDataSet(
